package com.invoicekeeperandanalyticsmobile;

import com.invoicekeeperandanalyticsmobile.generated.BasePackageList;
  ...
  private static void initializeFlipper(Context context, ReactInstanceManager reactInstanceManager) {
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.invoicekeeperandanalyticsmobile.ReactNativeFlipper");
